...
> Answer: less data is processed, and the routes are handled internally by the javascript that is already on the page. Makes things smoother and only requests the data it needs and updates that.
